...
const AuthorityStudentEdit = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/right/Authority/S_Edit.vue');
 ...
 /*角色模板*/
const Roles = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/right/Roles/roles.vue');
const RolesSee = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/right/Roles/See.vue');
const RolesSet = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/right/Roles/Set.vue');
const RolesAdd = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/right/Roles/Add.vue');
const RolesEdit = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/right/Roles/Edit.vue');
