...
/***********学年管理***********/  
	async xuenian (params) {
        const res = await network.post({
            url: 'schoolYear/list/page',
            data: params
        });
        return res;
    },
    async xuenianAdd (params) {
        const res = await network.post({
            url: 'schoolYear/add',
            data: params
        });
    ...
    async xuenianDelete(id) {
        const res = await network.delete({
            url: 'schoolYear/delete/'+id,
        });
        return res;
    },
/************学期管理***********/
	async xueqi (params) {
        const res = await network.post({
            url: 'semester/list/page',
            data: params
        });
        return res;
   	},
   	async xueqiAdd (params) {
        const res = await network.post({
            url: 'semester/add',
            data: params
        });
