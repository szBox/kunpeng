...
//学年管理
const XueNian = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/school/xuenian/xuenian.vue');
const XueNianAdd = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/school/xuenian/add.vue');

//学期管理
const XueQi = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/school/xueqi/xueqi.vue');
const XueQiAdd = () => import(/* webpackChunkName: "setting" */ '@src/general/app/setting/school/xueqi/add.vue');
export default [
    {
        path: 'gradeAdmin',
        name: 'gradeAdmin',
