				...
				columns: [{
				...
				
					{
						...
						renderContent: (h, {
							...
							return [
//								<el-button type='primary' style='border:1px solid #409EFF; color:#409EFF' on-click={() => this.$router.push(`depAdmin/see/${row.id}`)}  size='mini' >查看</el-button>,
								<el-button type='primary' on-click={() => this.$router.push(`depAdmin/edit/${row.id}`)}  size='mini' >更新</el-button>,
