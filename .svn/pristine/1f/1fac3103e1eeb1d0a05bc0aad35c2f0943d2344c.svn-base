<template>
    <div class="questType">
         ...
         <div class="button-box">
             <el-button class='btn-add' v-has="10010301" type="primary" icon="el-icon-plus" @click="$router.push('questStar/add')">添加</el-button>
...
//              ],
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        renderContent: (h, { row }) => {
                            return [
                            <el-button type='primary' size='mini' on-click={() => this.$router.push(`questStar/edit/${row.id}`)}>更新</el-button>,
